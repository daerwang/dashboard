...
@ContextConfiguration(locations = { 
		"file:src/main/resources/springcontext/test-as400-context-spring.xml", "file:src/main/resources/springcontext/local-as400-sp-spring.xml"})
public class ObStoredProcedureTest {
	...
	@Test
	public void test_execute_aml_batch_approval(){
		String sql = "IBMOB700.execute_aml_approval_bank_700";
		...
		proc.setParameter(1, "AML-2015-0002");
		proc.execute();
