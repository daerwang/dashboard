...
//		}
	...
	public void attachmentUpload(MultipartHttpServletRequest request, @RequestParam Map<String, String> allRequestParams) throws DashboardException, IOException {
    	...
    	if(mpf.getSize()/1024 > 10000){
        	throw new DashboardException("The upload should be less than 10MB in size.");
        }
	...
	public @ResponseBody String deleteDashboardUpload(@PathVariable("id") Long id){
		String result = null;
