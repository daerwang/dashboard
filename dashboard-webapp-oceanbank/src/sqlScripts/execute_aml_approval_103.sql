CREATE PROCEDURE IBMOB700.execute_aml_approval_103(IN i_requestId char(15), OUT o_status char(50)) 
LANGUAGE SQL 
BEGIN atomic
...
-- insert the logs
INSERT INTO XPERTV103.PAMLLOGCIF (
	AMLCBANKNU
	,AMLCCIFCOD
	,AMLCTYPLOG
	,AMLCSBTSUB
