CREATE PROCEDURE IBMOB700.execute_aml_approval_16(IN i_requestId char(15), OUT o_status char(50)) 
LANGUAGE SQL 
BEGIN atomic
...
-- insert the logs
INSERT INTO XPERTV16.PAMLLOGCIF (
	AMLCBANKNU
	,AMLCCIFCOD
	,AMLCTYPLOG
	,AMLCSBTSUB
