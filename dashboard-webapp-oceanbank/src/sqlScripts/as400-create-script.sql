...
select * from IBMOB700.IBTN007F1;
select * from IBMOB100.IBTN007F1;

ALTER TABLE IBMOB700.DASHBOARDUSER ADD resetToken VARCHAR(60);
ALTER TABLE IBMOB700.DASHBOARDUSER ADD resetExpiry TIMESTAMP;

ALTER TABLE IBMOB700.DASHBOARDUSER ADD accountNonLocked INT NOT NULL DEFAULT 0;
ALTER TABLE IBMOB700.DASHBOARDUSER ALTER COLUMN password SET DATA TYPE VARCHAR(60);
